...
files {
	...
	'html/img/header/save_tenue.jpg',
	...
	'html/img/header/GyroF.gif',
	'html/img/header/BANQUIER.png',
	'html/img/header/Concesionnaire.png',
	'html/img/header/EMS.png',
	'html/img/header/LSC.png',
	'html/img/header/TAXI.png',
	'html/img/header/VIGNERON.png',
	'html/img/header/WZ.png'
